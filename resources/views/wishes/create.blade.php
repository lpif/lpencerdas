...
<script>
    ...
    function getRMK(){
        ...
        $.ajax({ 
            type: 'GET', 
            url: 'http://10.151.253.122:8000/api/spec/', 
            dataType: 'json',
    ...
    function pilihRMK(){
        ...
        $.ajax({ 
            type: 'GET', 
            url: 'http://10.151.253.122:8000/api/specs/' + $('#select-rmk').find(":selected").val(),  
            dataType: 'json',
            success: function (data) { 
                $.each(data, function(index, element) {
                    var opt = new Option(element.name, element.id);
    ...
    function pilihCourse(){
        ...
        $.ajax({ 
            type: 'GET', 
            url: 'http://10.151.253.122:8000/api/course/' + $('#select-course').find(":selected").val(),
            dataType: 'json',
            success: function (data) { 
                $.each(data, function(index, element) {
                    var opt = new Option(element.name, element.id);
    ...
    function pilihChapter(){
        ...
        $.ajax({ 
            type: 'GET', 
            url: 'http://10.151.253.122:8000/api/chapter/' + $('#select-chapter').find(":selected").val(),
            dataType: 'json',
            success: function (data) { 
                console.log(data);
                $.each(data, function(index, element) {
